    ...
    ef = ve({ // 使用 ve 包装组件，模仿上传文件中的写法
        ...
        setup(e) { // setup 函数开始
            try {
                ...
                return (x, k) => le(
                    (Z(), ee("div", {
                        class: "note-obj-edit-frame-presentation", // 外层容器 class，控制整个编辑框界面
